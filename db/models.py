...
class CustomerMeta(db.Model):
    ...
    manual_customer = db.Column(db.Boolean, nullable=False, default=False)
    manual_nombre = db.Column(db.String(160), nullable=False, default="")
    manual_fecha_alta = db.Column(db.String(10), nullable=False, default="")
